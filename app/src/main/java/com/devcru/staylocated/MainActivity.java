...
public class MainActivity extends Activity {
    ...
    static final LatLng randomMarker = new LatLng(40, -79);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            */
            ...
            // Default start up location and camera zoom (current location)
            ...
            /*Marker marker = googleMap.addMarker(new MarkerOptions().
                    ...
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.blank_avatar)));*/
